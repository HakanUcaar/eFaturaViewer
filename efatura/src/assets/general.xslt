...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- A more robust template to add data-line to any generated element if its source had it -->
  <xsl:template match="*" priority="-1">
    <xsl:element name="{local-name()}">
      <xsl:if test="@data-line">
  ...
  <!-- Identity template to copy attributes and text nodes -->
